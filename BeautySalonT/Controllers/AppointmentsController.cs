...
namespace BeautySalonT.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public AppointmentsController(BeautySalonTContext context)
        {
            _context = context;
        }
        ...
        {
            var beautySalonTContext = _context.Appointment.Include(a => a.Client).Include(a => a.Service);
        ...
        public async Task<IActionResult> Create([Bind("Id,ServiceId,Time,ClientId,Date")] Appointment appointment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ServiceId,Time,ClientId,Date")] Appointment appointment)
        {
